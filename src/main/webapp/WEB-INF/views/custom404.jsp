                    ...
                    <div class="card-body">
                        ...
                        >
                            <div class="text-center">
                                <img class="z-index-2 mb-4" src="${pageContext.request.contextPath}/resources/assets/svg/logos/logo-ansim.png" alt="ANSIM USB v3.0" style="max-height: 3rem;">
                                <span class="divider text-muted mb-4"><h3>오류번호 : 404</h3></span>
                            </div>
