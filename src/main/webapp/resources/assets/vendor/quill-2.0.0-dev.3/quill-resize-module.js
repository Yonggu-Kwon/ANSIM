    ...
    ***************************************************************************** */
    ...
    var ResizePlugin = /** @class */ (function () {
        function ResizePlugin(resizeTarget, container, options) {
            ...
            this.editorScroll = this.editorScroll.bind(this);
        ...
        ResizePlugin.prototype.positionResizerToTarget = function (el) {
            if (this.resizer !== null) {
                ...
                this.resizer.style.setProperty("margin-top", (-1 * this.editor.scrollTop) + "px");
            }
        };
        ResizePlugin.prototype.bindEvents = function () {
            ...
            this.editor.addEventListener("scroll", this.editorScroll);
        };
        ...
        ResizePlugin.prototype.editorScroll = function (e) {
            this.positionResizerToTarget(this.resizeTarget);
        };
